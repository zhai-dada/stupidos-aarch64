...
CFLAGS=$(echo "-ffreestanding -fno-stack-protector -fno-builtin -I/home/zhai/myspace/stupidos-aarch64/userspace/include -I/home/zhai/myspace/stupidos-aarch64/include -O0" | sed "s#$prefix#$prefix_real#")
VERSION="3.10"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
